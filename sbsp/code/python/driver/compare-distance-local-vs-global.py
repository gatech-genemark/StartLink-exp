...
def compare_distance_local_vs_global(env, df, **kwargs):
    ...
    scatter(df, "global_length_no_gaps", "local_length_no_gaps", figure_options=FigureOptions(
    ...
    df["ratio_ungapped_length"] = df["local_length_no_gaps"] / df["global_length_no_gaps"]
