...
* Experiments
  ...
  #+begin_src bash
    ...
    # PBS options
    toggle_pbs="--pf-pbs-options $config/$pf_pbs_options[[file:../../../../org-roam/20200530050505-taylorseries.org][taylorseries]]"  # if PBS not installed, set this option to empty: ""
...
This will produce two files, =sensitivity.csv= and =coverage.csv= containing the following two tables.
