...
ABS_PATH_SCRIPT="$( cd -P "$( dirname "$SOURCE" )" >/dev/null && pwd )"

PATH_SCRIPT=$(dirname install.sh );



PATH_BASH_DRIVER=${PATH_SCRIPT}/code/bash/driver
PATH_PYTHON_DRIVER=${PATH_SCRIPT}/code/python/driver
PATH_PERL_DRIVER=${PATH_SCRIPT}/code/perl/driver
